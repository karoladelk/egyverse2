...
const Avatar = () => {
  ...
  return (
    <section className="text-white p-10 mb-0 flex flex-col md:flex-row items-center bg-cover bg-center bg-[#1c1a1f]" style={{ justifyContent: 'center', alignItems: 'center', marginBottom: "10vh" }}>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              <div className="lg:max-w-lg">
                <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">About Us</p>
                <p className="mt-6 text-lg leading-8 text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
                <div className="flex -space-x-2 overflow-hidden ">
                  <PiVirtualRealityThin className="text-white" style={{ fontSize: "50px" }} />
                  <p className="mt-2 text-lg leading-8 text-white pl-4">+20 Virtual Reality Tours</p>
                </div>
                <div className="flex -space-x-2 overflow-hidden ">
                  ...
                  <p className="mt-1 text-lg leading-8 text-white pl-5">+5,000 Customer Visits</p>
                </div>
              </div>
            </div>
